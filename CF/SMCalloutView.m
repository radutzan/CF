...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    if (self.contentView) {
        ...
        preferredWidth = self.contentView.$width;
    }
...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        if (!blackArrowImage) {
            ...
            whiteArrowImage = [self image:blackArrowImage withColor:[UIColor blackColor]];
            grayArrowImage = [self image:blackArrowImage withColor:[UIColor colorWithWhite:0.15 alpha:1]];
        }
...
- (void)setHighlighted:(BOOL)highlighted {
    ...
    self.containerView.backgroundColor = highlighted ? [UIColor colorWithWhite:0.15 alpha:1] : [UIColor blackColor];
