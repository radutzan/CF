...
#define TITLE_MARGIN 7 // the title view's normal horizontal margin from the edges of our callout view
...
- (CGFloat)calloutHeight {
    ...
    if (self.contentView) {
        height = self.contentView.$height + 3.0;
...
- (CAAnimation *)animationWithType:(SMCalloutAnimation)type presenting:(BOOL)presenting {
    ...
    if (type == SMCalloutAnimationBounce) {
        ...
        bounceAnimation.values = @[@0.7, @1.03, @1.0];
        bounceAnimation.keyTimes = @[@0, @(8.0/10.0), @1.0];
        bounceAnimation.duration = 1.0/4.0;
        bounceAnimation.timingFunctions = @[easeInOut, easeInOut];
        
        CABasicAnimation *fadeAnimation = [CABasicAnimation animationWithKeyPath:@"opacity"];
        fadeAnimation.duration = bounceAnimation.duration;
        fadeAnimation.fromValue = @0.0;
        fadeAnimation.toValue = @1.0;
        
        CAAnimationGroup *animationGroup = [CAAnimationGroup new];
        animationGroup.animations = @[bounceAnimation, fadeAnimation];
        
        animation = animationGroup;
    }
    else if (type == SMCalloutAnimationFade) {
        CABasicAnimation *fadeAnimation = [CABasicAnimation animationWithKeyPath:@"opacity"];
        fadeAnimation.duration = 1.0/6.0;
...
- (void)drawRect:(CGRect)rect
{
    ...
    // determine size
    CGFloat stroke = 1.0;
    CGFloat backgroundStrokeWidth = 0.25;
    CGFloat radius = [UIScreen mainScreen].scale == 1 ? 4 : 8.0;
    ...
    // Color Declarations
    UIColor* fillBlack = [UIColor colorWithWhite:0 alpha:0.95];
    UIColor* outerStrokeColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0];
...
//        CGContextSaveGState(context);
//        CGContextSetShadowWithColor(context, CGSizeMake(0, 0), 60, [UIColor colorWithWhite:0 alpha:0.1].CGColor);
//        CGContextRestoreGState(context);
        ...
        // Inner Stroke is actually outer stroke lol
